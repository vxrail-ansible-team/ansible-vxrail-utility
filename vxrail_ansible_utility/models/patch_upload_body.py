...
class PatchUploadBody(object):
    ...
    def __init__(self, component_bundle=None):  # noqa: E501
        """PatchUploadBody - a model defined in Swagger"""  # noqa: E501
    ...
    def component_bundle(self):
        """Gets the component_bundle of this PatchUploadBody.  # noqa: E501

        Indicates the file path on the local machine.  # noqa: E501

        :return: The component_bundle of this PatchUploadBody.  # noqa: E501
        :rtype: str
        """
    ...
    def component_bundle(self, component_bundle):
        """Sets the component_bundle of this PatchUploadBody.

        Indicates the file path on the local machine.  # noqa: E501

        :param component_bundle: The component_bundle of this PatchUploadBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchUploadBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchUploadBody):
            return False
