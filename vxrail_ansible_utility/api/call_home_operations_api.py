...
class CallHomeOperationsApi(object):
    ...
    def v3_callhome_enable_post(self, body, **kwargs):  # noqa: E501
        """Enable call home functionality  # noqa: E501

        Enable call home functionality by enabing remote connectivity service.<br/> if remote connector type is ESE <br/>     1) Update ESE state to configuring <br/>     2) Initialize ESE lockbox<br/>     3) Update ESE configuation (product/gateway/proxy )<br/>     4) Generate universal key by PIN/access key or upload pre-installed universal key to ESE <br/>     5) Enable ESE connection<br/>     6) Update ESE state to configured<br/> v2 adds support for IPv6 connectivity<br/>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v3_callhome_enable_post(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param EnableCallhomeSpecV3 body: (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.v3_callhome_enable_post_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.v3_callhome_enable_post_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def v3_callhome_enable_post_with_http_info(self, body, **kwargs):  # noqa: E501
        """Enable call home functionality  # noqa: E501

        Enable call home functionality by enabing remote connectivity service.<br/> if remote connector type is ESE <br/>     1) Update ESE state to configuring <br/>     2) Initialize ESE lockbox<br/>     3) Update ESE configuation (product/gateway/proxy )<br/>     4) Generate universal key by PIN/access key or upload pre-installed universal key to ESE <br/>     5) Enable ESE connection<br/>     6) Update ESE state to configured<br/> v2 adds support for IPv6 connectivity<br/>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v3_callhome_enable_post_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v3_callhome_enable_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `v3_callhome_enable_post`")  # noqa: E501
