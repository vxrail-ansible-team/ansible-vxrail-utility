...
class LCMPreCheckApi(object):
    ...
    def precheck_v2(self, body, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.precheck_v2_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.precheck_v2_with_http_info(body, **kwargs)  # noqa: E501
            return data
    ...
    def precheck_v2_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `precheck_v2`")  # noqa: E501
    ...
    def v1_upload_bundle_customized_component(self, customized_component, checksum, type, **kwargs):  # noqa: E501
        ...
        Upload the content of the file to any designated location. Limitation: - Only one file can be uploaded at a time. - The file size should not exceed 20 GB. - The free disk space of designated location should be at least 40 GB. - For LCM bundles, only support SLIM or FULL bundles.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
